...
export const LoginForm: React.FC = () => {
  ...
  // CLEANUP: Removed unused 'success' state - it was set but never rendered
  const [formData, setFormData] = useState({ email: '', password: '' })
  const [errors, setErrors] = useState<Record<string, string>>({})

  const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/

  // CLEANUP: Unified error validation into single function
  ...
  // CLEANUP: Added proper error type and improved login flow
...
// CLEANUP: Removed unused PasswordStrength component that was exported but never imported elsewhere
