...
import { Menu, Bell, User, LogOut, CheckCircle2, Home } from "lucide-react";
...
export const Navbar = ({ toggleDrawer, isAuthenticated = false, transparent = false }: NavbarProps) => {
      ...
      <div className="flex items-center justify-center w-full">
        <div className="w-full max-w-7xl mx-auto px-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            {isAuthenticated && (
              <>
                <Button variant="ghost" size="icon" onClick={toggleDrawer} className="mr-2">
