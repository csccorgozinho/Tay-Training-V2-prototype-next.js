...
export const Drawer = ({ open, onOpenChange }: DrawerProps) => {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetTrigger />
      <SheetContent side="left" className="p-0 w-[280px] border-r h-full flex flex-col">
        <div className="flex flex-col h-full">
          ...
          >
            <h2 className="text-xl font-semibold text-primary flex items-center">Tay Training</h2>
          </motion.div>
                    ...
                    >
                      ...
                      >
                        ...
                        <motion.div
                          ...
                          transition={{ type: 'spring', stiffness: 400, damping: 30 }}
                        >
                          <ChevronRight className={cn("h-4 w-4", isActive && "text-primary")} />
                        </motion.div>
                      </Button>
                    </motion.div>
                  </motion.li>
