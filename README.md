...
- **📋 Exercise Management** - Create, organize, and categorize exercises
- **🎯 Training Methods** - Define and manage training methodologies
- **📅 Training Schedule** - Plan and schedule workouts
- **📊 Workout Sheets** - Detailed workout tracking with filtering and grouping
